Feature: Centigrade to Fahrenheit and Fahrenheit to Centigrade Converter
  As a user
  I want to enter data in Centigrade/Fahrenheit
  So that I get the output in Fahrenheit/Centigrade

  Scenario Outline: Centigrade to Fahrenheit and Fahrenheit to Centigrade Converter
